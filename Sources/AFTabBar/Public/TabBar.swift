...
public struct TabBar<Selection, Content>: View where Selection: Hashable, Content: View {
    ...
    @State private var lastSelectedItem: Selection?
    @StateObject private var scrollToTopSubject = ScrollToTopSubject()
    ...
    public var body: some View {
        GeometryReader { geo in
            ZStack(content: content)
                ...
                .environmentObject(scrollToTopSubject)
        }
    }
